...
retry2:
    ...
    Risposta = InputComTimeOut(20)

    Debug.Print Risposta
    If fDebug Then Print #fdn, Risposta
...
Repeat:
    ...
    If fDebug Then Print #fdn, "Numero bytes"; Stringa

    iVersione = InStr(Stringa, Versione)
    If iVersione <> 0 Then GoTo Repeat

    If Stringa <> "TimeOut" Then
        fMain.lBytes.Caption = Left(Stringa, Len(Stringa) - 2)
        fMain.StatusBar1.Panels(2).Text = Left(Stringa, Len(Stringa) - 2) & " Bytes"
    Else
        GoTo Failed
    End If
    
    Stringa = InputComTimeOut(5)
    If fDebug Then Print #fdn, "volt"; Stringa
    If Stringa <> "TimeOut" Then
        fMain.lVolts.Caption = Left(Stringa, Len(Stringa) - 2)
        fMain.StatusBar1.Panels(1).Text = Left(Stringa, Len(Stringa) - 2) & " volt"
    ...
    Stringa = InputComTimeOut(5)
    If fDebug Then Print #fdn, "Centralina numero "; Stringa
    If Stringa <> "TimeOut" Then
        fMain.frameCentralina.Caption = "Centralina N. " + Left(Stringa, Len(Stringa) - 2)
        fMain.StatusBar1.Panels(3).Text = "Centralina N. " + Left(Stringa, Len(Stringa) - 2)
    Else
        GoTo Failed
    End If
    ...
    Stringa = ""
    Stringa = InputComTimeOut(5)
    If fDebug Then Print #fdn, "Fattore Batteria "; Stringa
    If Stringa <> "TimeOut" Then
    ...
    AbilitaTasti
    fMain.bFine.Enabled = True
    fMain.bConnetti.Enabled = False
    'fmain.StatusBar1.Panels(1).Text = "Connesso"
    fMain.MSComm1.InBufferCount = 0
    ConnessioneRemota = True
    fMain.bDisconnect.Enabled = True
    Me.Hide
    Unload Me
